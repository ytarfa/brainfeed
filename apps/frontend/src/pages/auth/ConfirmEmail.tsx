...
export default function ConfirmEmail() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] flex items-center justify-center p-6">
      ...
      <div className="bg-[var(--bg-raised)] border border-[var(--border-subtle)] rounded-2xl px-9 pt-9 pb-8 w-full max-w-[420px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] animate-fade-in relative text-center">
        {/* Logo */}
        <div className="mb-7">
        ...
        {/* Success message */}
        {resent && (
          <div className="bg-[rgba(61,214,140,0.08)] border border-[rgba(61,214,140,0.2)] rounded-lg px-3.5 py-2.5 mb-4 text-[13px] text-[var(--text-primary)] font-ui">
