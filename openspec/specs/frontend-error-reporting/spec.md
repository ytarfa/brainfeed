...
Defines the frontend error reporting infrastructure (`@brain-feed/frontend-error-reporter` package) including error boundary, reporting hook, and pluggable reporter singleton for the React SPA.
