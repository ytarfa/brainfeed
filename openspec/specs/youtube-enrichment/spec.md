...
YouTube-specific enrichment logic — URL classification, transcript loading, and metadata fetching for videos, channels, and playlists via the YouTube Data API.
